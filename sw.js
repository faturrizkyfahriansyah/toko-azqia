/**
 * sw.js - Service Worker TOKO AZKIA.
 ...
 */
var CACHE_NAME = 'azkia-shell-v1';
var SHELL_FILES = [
  './', './index.html', './manifest.json', './offline.html',
  './css/style.css',
  './js/utils.js', './js/api.js', './js/auth.js', './js/config.js', './js/cart-state.js', './js/router.js', './js/layout.js',
  './js/printer/receiptBuilder.js', './js/printer/browserAdapter.js', './js/printer/thermalAdapter.js', './js/printer/printerInterface.js',
  './internal/login.js', './internal/dashboard.js', './internal/pos.js', './internal/products.js', './internal/inventory.js',
  './internal/purchases.js', './internal/suppliers.js', './internal/customers.js', './internal/orders.js', './internal/reports.js',
  './internal/users.js', './internal/settings.js',
